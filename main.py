...
def main_function(sc):                                                          # our main function
    ...
    s.enter(300, 1, main_function, (sc,))                                            # here I added timer as 300 sec, so this script 
                                                                                    # runs in every 300 sec intervel to check updates in IIT database for course avaliability
s.enter(300, 1, main_function, (s,))                                                 # and will start playing GOT ringtone as a notification
s.run()
